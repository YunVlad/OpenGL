...
int process()
{
    ...
    render.createSkybox(cubeShaders, backShaders, "PBR/forest.hdr");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (preRender)
        {
            ...
            render.setCaptureViews(glm::vec3(0.0f, 0.0f, 0.0f));
            ...
            render.createEnvDiffuse(convEnvShaders, glm::vec3(0.0f, 0.0f, 0.0f), 0);
            render.createEnvSpec(prefEnvShaders, glm::vec3(0.0f, 0.0f, 0.0f), 0);
            render.createEnvBRDF(BRDFEnvShaders, glm::vec3(0.0f, 0.0f, 0.0f), 0);
            preRender = false;
        }
