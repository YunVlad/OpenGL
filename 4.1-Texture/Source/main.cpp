...
int main()
{
    ...
    unsigned int texture1 = render.loadTexture("Resources/tile.jpg");
    unsigned int texture2 = render.loadTexture("Resources/ground1.jpg");
    ...
    shaders.IntUniform("textureMap", 0);
    shaders.IntUniform("shadowMap", 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        plateModel = glm::scale(plateModel, glm::vec3(20.0f, 20.0f, 20.0f));
