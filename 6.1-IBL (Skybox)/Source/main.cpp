...
int process()
{
    ...
    shader cubeShaders("Shaders/VertexCube", "Shaders/ColorCube");
    shader envShaders("Shaders/VertexEnv", "Shaders/ColorEnv");
    ...
    render.createSkybox(cubeShaders, envShaders, "PBR/test.hdr");
    ...
    envShaders.mat4Uniform("proj", proj);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //Skybox render
        envShaders.UseShaderProgramm();
        envShaders.mat4Uniform("view", view);
        render.skyboxRender();
