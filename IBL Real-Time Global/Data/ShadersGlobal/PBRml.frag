...
vec3 RenderingEquation_withShadow(pointLight light, vec3 Norm, vec3 currPos, vec3 viewDir, float roughness, float metallic, vec3 albedo, vec3 F0)
{
...
void main()
{
    ...
    L0 += RenderingEquation_withShadow(lights[0], norm, currPos, viewDir, roughness, metallic, albedo, F0);
